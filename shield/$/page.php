...
<article>
  ...
  <footer>
    <ul class="metas">
      ...
      <li><span class="abbr" title="<?php echo $page->time->format('Y/m/d H:i:s') . ' &ndash; ' . $page->update->format('Y/m/d H:i:s'); ?>"><svg class="icon" viewBox="0 0 24 24"><path d="M12,20A8,8 0 0,0 20,12A8,8 0 0,0 12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22C6.47,22 2,17.5 2,12A10,10 0 0,1 12,2M12.5,7V12.25L17,14.92L16.25,16.15L11,13V7H12.5Z"></path></svg> <?php echo $page->time->format('H:i A'); ?></span></li>
      <?php endif; ?>
      <?php if (Plugin::exist('view')): ?>
      <li><span><svg class="icon" viewBox="0 0 24 24"><path d="M12,9A3,3 0 0,0 9,12A3,3 0 0,0 12,15A3,3 0 0,0 15,12A3,3 0 0,0 12,9M12,17A5,5 0 0,1 7,12A5,5 0 0,1 12,7A5,5 0 0,1 17,12A5,5 0 0,1 12,17M12,4.5C7,4.5 2.73,7.61 1,12C2.73,16.39 7,19.5 12,19.5C17,19.5 21.27,16.39 23,12C21.27,7.61 17,4.5 12,4.5Z"></path></svg> <?php echo $page->view; ?></span></li>
      <?php endif; ?>
      <?php if (Extend::exist('poll')): ?>
      <li><a href=""><span><svg class="icon" viewBox="0 0 24 24"><path d="M23,10C23,8.89 22.1,8 21,8H14.68L15.64,3.43C15.66,3.33 15.67,3.22 15.67,3.11C15.67,2.7 15.5,2.32 15.23,2.05L14.17,1L7.59,7.58C7.22,7.95 7,8.45 7,9V19A2,2 0 0,0 9,21H18C18.83,21 19.54,20.5 19.84,19.78L22.86,12.73C22.95,12.5 23,12.26 23,12V10M1,21H5V9H1V21Z"></path></svg> 47</span></a></li>
      <?php endif; ?>
      <?php if ($site->has('parent')): ?>
  ...
  <?php if ($site->has('parent') && Extend::exist('comment') && HTTP::get($c) && $site->is('page')): ?>
  <?php static::comments(); ?>
  <?php endif; ?>
</article>
